...
CAPITAL_MODE = 'fixed'           # 'fixed' | 'percentage'
CAPITAL_AMOUNT_USDT = 7.0           # Used when CAPITAL_MODE = 'fixed'
...
MIN_POSITION_SIZE_USDT = 7.0         # Minimum order size allowed by platform
MIN_POSITION_FOR_POINTS_USDT = 7.0  # Minimum size to earn airdrop points
...
IMPROVEMENT_TINY = 0.10    # Join the queue (no improvement)
IMPROVEMENT_SMALL = 0.20   # $0.10 better than best
IMPROVEMENT_MEDIUM = 0.40  # $0.20 better than best
IMPROVEMENT_WIDE = 0.70    # $0.30 better than best
...
DEFAULT_SCORING_PROFILE = 'test_quick_fill'

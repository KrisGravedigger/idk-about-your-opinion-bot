...
def main():
    ...
    # Use config from config_loader (merges config.py + bot_config.json + .env)
    ...
    USE_LIQUIDITY_FARMING = config.USE_LIQUIDITY_FARMING
    LIQUIDITY_FARMING_CONFIG = config.LIQUIDITY_FARMING_CONFIG
    USE_SPREAD_FARMING = config.USE_SPREAD_FARMING
